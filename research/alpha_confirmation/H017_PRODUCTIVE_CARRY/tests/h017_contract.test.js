...
describe('H017 Confirmatory Contract & Cryptographic Lock Tests', () => {
  ...
  const charterPath = path.join(baseDir, 'charter/H017_CONFIRMATORY_CHARTER.md');
  ...
  it('G-LOCK-02: Preregistration Lock exists and has valid lifecycle state', () => {
    ...
    expect(lock.hypothesisId).toBe('H017');
