...
describe('H015 Confirmatory Contract & Cryptographic Lock Tests', () => {
  const baseDir = path.resolve(process.cwd(), 'research/alpha_confirmation/H015_REGIME_GATED_CARRY');
  ...
  it('G-LOCK-02: Preregistration Lock exists and is valid', () => {
    ...
    expect(lock.hypothesisId).toBe('H015');
  ...
  it('G-LOCK-04: Confirmatory Charter specifies non-adaptive single-hypothesis protocol (M=1)', () => {
    const charterPath = path.join(baseDir, 'charter/H015_CONFIRMATORY_CHARTER.md');
